...
export const metadata: Metadata = {
  ...
  keywords: [
    "SinglishX", "සිංහල", "Singlish Typer", "Sinhala Unicode",
    "Sinhala Unicode Converter", "Sinhala Typing", "Type in Sinhala",
    "Real Time Unicode Converter", "Singlish typing", "Sinhala online keyboard",
    "Helakuru", "Sinhala font converter", "Unicode Sinhala typing",
    "Sinhala Unicode Typing", "UCSC", "University of Colombo",
    "University of Moratuwa", "University of Peradeniya", "Engineering Faculty",
    "Januda", "Januda J Kodithuwakku", "Januda Janandith", "Singlish.lk",
    "online keyboard Sinhala", "Sinhala realtime typing", "Sinhala language tools",
    "Sinhala AI typing", "Sri Lanka Sinhala typing",
  ],
